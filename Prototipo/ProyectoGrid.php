        ...
        <div class="card">
          ...
          <div class="card-body">
            <div id="table" class="table-editable">
              ...
              <table class="table table-bordered table-responsive-md table-striped text-center" id ="projectsTable" name="projectsTable">
                <thead>
                  <tr>
...
function ProjectsGridFillGrid() {		

var proyectos = [];
        $.getJSON( "FileProjects.json", function( json )
        {       
		var datos = json;
		for(i in datos)
          {
