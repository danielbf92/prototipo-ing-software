    ...
    <div class="row">
      ...
      <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
          <h1 class="h2">Reporte de Requerimientos</h1>
              ...
              <table class="table table-bordered table-responsive-md table-striped text-center">
                ...
                <tbody>
                  <tr>
                    ...
                    <td class="text-center">Base de datos Usuario</td>
					<td class="text-center">Alta</td>
					<td class="text-center">No funcional</td>
                    <td>
                      <span class="table-remove"><button type="button"
                          class="btn btn-success btn-rounded btn-sm my-0">Aprobado</button></span>
                    </td>
                    <td>
                      <span class="table-remove"><button type="button"
